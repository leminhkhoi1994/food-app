...
export const onValidateLengthFileType = ({ files = [], type = "video", maxLength = 1 }) => {
...
export const onValidateFiles = ({ files = [], maxLength = 10, maxSize = 2097152, maxLengthFileType = null }) => {
  if (files && files.length) {
