...
export const getCurrentDateTime = () => {
  ...
  const formatTimestamp = momentTimezone(new Date().toUTCString()).tz(timeZone).format(DATETIME_LOCAL_MS)
...
export const formatDate = (date, styleFormat = DATETIME_LOCAL_MS) => moment(date).format(styleFormat)
...
export const onGetDateRangeByFrequency = ({ isUpdatedFrequency = false, frequency, date }) => {
