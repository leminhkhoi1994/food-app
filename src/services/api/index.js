...
export const getData = ({ url, isAuthenticated = true, responseType, params, cancelToken }) =>
  instance({
    method: METHOD.GET,
...
export const postData = ({ url, isAuthenticated = true, responseType, contentType, data }) =>
  instance({
    method: METHOD.POST,
...
export const putData = ({ url, isAuthenticated = true, responseType, contentType, data }) =>
  instance({
    method: METHOD.PUT,
    headers: setHeader(isAuthenticated, contentType),
    url,
...
export const patchData = ({ url, isAuthenticated = true, responseType, data }) =>
  instance({
    method: METHOD.PATCH,
    headers: setHeader(isAuthenticated),
    url,
